    ...
    <div ref={containerRef} style={{ minHeight: '100vh', background: currentTheme.bgPrimary, color: currentTheme.textPrimary, transition: 'all 0.5s ease' }}>
     ...
     <button 
      ...
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 8vw', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="hero-scroll" style={{ position: 'relative', bottom: '3rem', left: '8vw', display: 'flex', alignItems: 'center', gap: '1rem', letterSpacing: '0.1em', textTransform: 'uppercase', transition: 'opacity 0.8s ease 1.3s' ,marginTop: '7rem', // Augmente l'espace avec les boutons
            opacity: 0.9,
            fontSize: '0.9rem',
            textAlign: 'center',
